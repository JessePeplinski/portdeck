...
The Hostinger adapter is account-wide and strictly read-only. PortDeck accepts the official Hostinger CLI `>=3.7.0 <4.0.0` and invokes only its paginated JSON website-list command:
