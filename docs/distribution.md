...
The current public beta is `v0.1.0-beta.17` for Apple Silicon Macs running macOS 14 or newer:
...
- [`PortDeck-0.1.0-beta.17-macos-arm64.zip`](../../../releases/download/v0.1.0-beta.17/PortDeck-0.1.0-beta.17-macos-arm64.zip)
- [`PortDeck-0.1.0-beta.17-macos-arm64.zip.sha256`](../../../releases/download/v0.1.0-beta.17/PortDeck-0.1.0-beta.17-macos-arm64.zip.sha256)

The next release target is `v0.1.0-beta.18`.
...
```bash
npm run generate:mac:sparkle-appcast -- docs/release-notes/v0.1.0-beta.17.md
```
